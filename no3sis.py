...
Usage:
    python no3sis.py template list
    python no3sis.py template info <name>
    python no3sis.py template validate <name>
...
Examples:
  ...
  python no3sis.py template info file_creator

  # Validate template
  python no3sis.py template validate file_creator
